...
@section('header')
    <!-- Page Title  -->
    <title>Data Riwayat Permohonan Surat | {{ config('app.name') }}</title>
@endsection
                    ...
                    <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-between">
                            <div class="nk-block-head-content">
                                <h3 class="nk-block-title page-title">Data Riwayat Permohonan Surat</h3>
                                ...
                                <table class="datatable-init-export nowrap table" data-export-title="Export">
                                    ...
                                    @foreach ($permohonanSurat as $surat)
                                        <tr>
                                            ...
                                            <td>
                                                <span class="{{ $surat->status == 'disetujui' ? 'text-success' : 'text-danger' }}">{{ $surat->human_status }}</span>
                                            </td>
                                            <td class="text-center">
                                                <div>
                                                    <a href="{{ route('surat.history-permohonan.detail', $surat->id) }}" class="btn btn-sm btn-info editBtnModal" data-bs-placement="top" title="Detail" data-bs-toggle="tooltip" style="--bs-btn-padding-x: 0.35rem;">
