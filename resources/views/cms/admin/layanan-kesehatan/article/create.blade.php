                    ...
                    <div class="nk-block nk-block-lg">
                        ...
                        <div class="card card-bordered card-preview">
                            <div class="card-inner">
                                <div class="card-head">
                                    <h5 class="card-title">Tambah Artikel Layanan Kesehatan</h5>
                                </div>
                                <form action="{{ route('layanan-kesehatan.article.store') }}" class="gy-3 form-validate" method="post">
                                    @csrf
                                    ...
                                    <div class="row g-3 align-center">
                                        ...
                                        <div class="col-lg-10">
                                            <div class="form-group {!! $errors->has('conten') ? 'has-error' : '' !!}">
                                                <div class="form-control-wrap">
                                                    <textarea name="conten" class="form-control editor-textarea" rows="20" required></textarea>
                                                </div>
                                                ...
                                                <ul class="custom-control-group g-3 align-center flex-wrap">
                                                    <li>
                                                        <div class="custom-control custom-radio">
                                                            <input type="radio" class="custom-control-input" value="1" name="publish" id="reg-enable">
                                                            <label class="custom-control-label" for="reg-enable">Yes</label>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="custom-control custom-radio">
                                                            <input type="radio" class="custom-control-input" value="0" checked name="publish" id="reg-disable">
